...
bail_guidelines = {
    "himachal_specific": {
        "description": "Special bail considerations for cases in Himachal Pradesh.",
        "categories": {
            "environmental": {
                "acts": ["Environment Protection Act", "Forest Conservation Act", "HP Ground Water Act"],
                "considerations": [
            ...
            "wildlife": {
                "acts": ["Wildlife Protection Act 1972", "Indian Forest Act 1927", "HP Forest Act"],
                "considerations": [
                    "Nature and gravity of wildlife offense",
                    "Impact on protected species",
                    "Cooperation with forest authorities",
                    "Local community impact"
                ]
            },
            "tribal_rights": {
                "acts": ["Forest Rights Act", "PESA Act"],
                "considerations": [
                    "Traditional forest rights claims",
        ...
        "general_guidelines": [
            "Consider local customs and traditional practices",
            "Evaluate community impact of detention",
            "Assess environmental restoration proposals",
            "Review tribal rights documentation"
        ]
    },
    "bailable": {
...
jurisdiction_types = {
    ...
    "District & Sessions Courts (12 Districts)": {
...
def get_bail_information(section, act="IPC"):
    ...
    # Himachal Pradesh specific environmental and wildlife cases
    if act in ["Wildlife Protection Act", "Forest Conservation Act", "HP Forest Act"]:
        # Check if case falls under special categories defined in bail_guidelines["himachal_specific"]
        if "environmental" in bail_guidelines["himachal_specific"]["categories"]:
            return {
                "category": "environmental",
                "guidelines": bail_guidelines["himachal_specific"]["categories"]["environmental"],
                "general_guidelines": bail_guidelines["himachal_specific"]["general_guidelines"]
            }
        elif "wildlife" in bail_guidelines["himachal_specific"]["categories"]:
            return {
                "category": "wildlife",
                "guidelines": bail_guidelines["himachal_specific"]["categories"]["wildlife"],
                "general_guidelines": bail_guidelines["himachal_specific"]["general_guidelines"]
            }
        elif "tribal_rights" in bail_guidelines["himachal_specific"]["categories"]:
            return {
                "category": "tribal_rights",
                "guidelines": bail_guidelines["himachal_specific"]["categories"]["tribal_rights"],
                "general_guidelines": bail_guidelines["himachal_specific"]["general_guidelines"]
            }
...
def get_jurisdiction_info():
    ...
    return court_jurisdiction_data
...
def fetch_case_status(case_number, state_code=None):
    """Fetch case status from eCourts API"""
    try:
        # API endpoint for case status
        url = f"{ECOURTS_API_BASE}/case-status"
...
def get_state_courts():
    """Get list of courts by state"""
    try:
        url = f"{ECOURTS_API_BASE}/courts"

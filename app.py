...
st.markdown("""
<div class='popular-sections-container'><h1 style="text-align:center">Some Popular Sections</h1></div>
    <style>
...
# Add navigation for Predictive Module and Case Metadata Viewer
st.sidebar.markdown("### Analytics & Prediction")
if st.sidebar.button('📈 Predictive Module', key='predictive_module_btn', use_container_width=True):
    st.switch_page('pages/predictive_module.py')
if st.sidebar.button('📑 Case Metadata Viewer', key='case_metadata_viewer_btn', use_container_width=True):
    st.switch_page('pages/case_metadata_viewer.py')

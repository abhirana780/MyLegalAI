...
def fetch_village_data(selected_district, selected_tehsil):
    """Fetch live village legal data from government portals"""
    import requests
    
    base_urls = [
        f"https://edistrict.hp.gov.in/api/district/{selected_district}",
        f"https://lgd.gov.in/api/village/{selected_district}/{selected_tehsil}",
        f"https://nyayakendra.hp.gov.in/api/cases/{selected_district}"
    ]
...
def generate_village_data(selected_district, selected_tehsil):
            ...
            return case_counts, monthly_trends, land_revenue, lok_adalat, legal_aid_camps,case_counts, monthly_trends, land_revenue, lok_adalat, legal_aid_camps : generate_village_data(selected_district, selected_tehsil)

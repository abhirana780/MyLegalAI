                    ...
                    for district, tehsils in filtered_districts.items():
                        ...
                        for tehsil, tehsil_info in tehsils.items():
                            with st.container():
                                ...
                                st.markdown(f"Name: {tehsil_info.get('name', 'N/A')}")
                                st.markdown(f"Type: {tehsil_info.get('type', 'N/A')}")
                                st.markdown(f"Address: {tehsil_info.get('address', 'N/A')}")
                                st.markdown(f"Jurisdiction: {tehsil_info.get('jurisdiction', 'N/A')}")
                                st.markdown("---")

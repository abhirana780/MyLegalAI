...
def main():
    ...
    st.markdown("<p class='section-title'>Secure Storage & Version Control for Legal Documents</p>", unsafe_allow_html=True)
    ...
    with tab1:
        ...
        st.markdown("Securely store your legal documents with automatic processing and OCR")

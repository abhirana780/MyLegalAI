...
try:
    ...
    print(f"Warning: Tokenization may be limited: {e}")
    ...
    def _load_argument_templates(self):
        ...
        return {
            ...
            "defense_favor": [
                ...
                "The accused has demonstrated commitment to environmental conservation in the past.",
                "The alleged violation was unintentional and steps were taken for immediate remediation.",
                "The accused has cooperated fully with forest authorities during investigation.",
                "The environmental impact of the alleged offense is minimal and reversible.",
                "The accused has strong ties to the local community and has contributed to conservation efforts.",
            ...
            "bail_favor": [
                # Himachal Pradesh specific bail arguments
                "The accused is a local resident with deep ties to the tribal community.",
                "The alleged forest offense is minor and does not warrant pre-trial detention.",
                "The accused has demonstrated willingness to participate in environmental restoration.",
                "The case involves traditional forest rights protected under local laws.",
                "The accused has no history of environmental violations or wildlife crimes.",
